...
const LoginForm: FC<IloginFormPros> = ({ onSubmit }) => {
    ...
    const initialValues = {
        ...
        password: process.env.REACT_APP_PASSWORD && process.env.NODE_ENV !== "production" ? process.env.REACT_APP_PASSWORD : ""
    }
                    ...
                    <div className="container-inputs-login">
                        ...
                        <div className="input-group">
                            ...
                            <span onClick={() => {
                                ...
                                {type === 0 && <i style={{ color: '#1FAEEF' }} className="fa fa-eye-slash" aria-hidden="true" />}

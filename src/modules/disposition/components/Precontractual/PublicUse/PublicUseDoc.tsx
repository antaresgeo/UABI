            ...
            <div className="container-fluid">
                    ...
                    <div id="page_1">
                        ...
                        <div id="id1_2">
                            ...
                            <p className="p9 ft6 my-3">
                                Para efectos del contrato de Administración del Espacio Público se tendrá como valor el
                                avalúo catastral (Inserte valor en letras), (Inserte valor en números).
                            </p>
                            <p className="p9 ft6">
                                <span className="ft3">3.</span>
                                <span className="ft4">Solicitante: </span>(Digite el nombre de la persona jurídica que
                                solicita el inmueble en Administración del Espacio Público) NIT: (Digite el número de
                                identificación tributaria de la persona jurídica que solicita el inmueble en
                                Administración del Espacio Público.)
                            </p>
                            <p className="p9 ft6" style={{ marginTop: '15px' }}>
                                <span className="ft3">4.</span>
                                <span className="ft4">
                                    La descripción de la necesidad que el MUNICIPIO DE MEDELLÍN pretende satisfacer con
                                    la contratación.
                                </span>
                            </p>
                            <p className="p9 ft6">
                                La Constitución Política de Colombia, elevó al rango constitucional al Espacio Público;
                                dicha protección es compatible con los principios que la rigen y como garantía a unos
                                derechos sociales y colectivos, como la recreación y el aprovechamiento del tiempo
                                libre, el goce de un medio ambiente sano y el derecho a reunirse y manifestarse
                                públicamente.
                            </p>
                            <p className="p10 ft6">
                                El artículo 5 de la Ley 9 de 1989, determinó que el espacio público, alude al conjunto
                            ...
                            <p className="p10 ft7">
                                ...
                                edificaciones sobre las vías, fuentes de agua, parques, plazas, zonas verdes, entre
                                otras. Así mismo, en su Artículo 7º, los Municipios tienen el deber de:
                                <span className="ft9">
                                    “Crear, de acuerdo con su organización legal, entidades responsables de administrar,
                                    desarrollar, mantener y apoyar financieramente el espacio público, el patrimonio
                                    inmobiliario y las áreas de cesión obligatoria para vías, zonas verdes y servicios
                                    comunales”,
                                </span>{' '}
                                así, como para contratar la administración, mantenimiento y aprovechamiento económico de
                            ...
                            <p className="p12 ft10">
                                ...
                                por la protección, conservación y restitución del espacio público de la ciudad, así como
                                de llevar a cabo, todos los procesos contractuales encaminados a lograr un adecuado
                ...
                <Card style={{ width: '850px', margin: '0 auto', marginTop: '10px' }}>
                    <div id="page_2">
                        ...
                        <div id="id2_2">
                            <p className="p4 ft0">
                                de Hacienda, actualmente Secretaría de Suministros y Servicios según el Decreto 883 de
                                2015.
                            </p>
                            <p className="p19 ft6">
                                ...
                                Constitución y en la Ley dichos espacios públicos requieren de una adecuada, eficiente y
                                eficaz administración.
                            </p>
                            <p className="p20 ft5">
                                Se diseñaron en el Plan de Ordenamiento Territorial, acuerdo 048 de 2014, unos
                                Instrumentos para la Gestión del Espacio Público, enfocados en el manejo y
                                administración del espacio público a través de la celebración de Contratos de
                                Administración del Espacio Público.
                            </p>
                            <p className="p20 ft5">
                                ...
                                para efectos de garantizar la conservación, protección y mejoramiento de los mismos y su
                                entorno.
                            </p>
                            <p className="p21 ft15">
                                Dicho contrato no implica el cerramiento de áreas públicas, las cuales no podrán ser
                                privatizadas, salvo por razones de seguridad previamente acreditadas.
                            </p>
                            <p className="p22 ft3">1.2 Forma de satisfacer la necesidad.</p>
                            <p className="p23 ft0">
                                El Municipio de Medellín administra los bienes inmuebles de su propiedad dando prelación
                                al interés general, fundamentándose en los principios de igualdad, moralidad, eficacia,
                                economía, celeridad, imparcialidad y publicidad, los cuales rigen la función
                                administrativa de conformidad con lo establecido por el artículo 209 de la Constitución
                                Política de Colombia. En ese sentido, se ha convenido suscribir contratos de
                                administración de bienes de uso público con la finalidad de permitir que las personas
                                naturales o jurídicas, públicas o privadas, se aprovechen de los espacios de uso público
                                dándoles su debida administración, uso y mantenimiento.
                            </p>
                            <p className="p24 ft0">
                                Previsto lo anterior y para satisfacer la necesidad planteada, se solicita celebrar un
                                contrato de Administración de Bien Inmueble de Uso Público, el cual permita entregar en
                                calidad de administración un bien inmueble propiedad del Municipio de Medellín a la
                                (digite nombre de la persona jurídica), persona Jurídica, de naturaleza civil, sin ánimo
                                de lucro, identificado con número de identificación tributaria No. (Digite el NIT)
                            </p>
                            <p className="p24 ft5">
                    ...
                    <div id="page_3">
                        ...
                        <div id="id3_2">
                            <p className="p9 ft0">
                                ...
                                del Municipio de Medellín identificado con matrícula (digite el número de la matrícula
                                inmobiliaria del bien a entregar en Administración del Espacio Público), CBML (Digite el
                                número del CMBL del bien inmueble), activo fijo (Digite el número del código del activo
                                fijo correspondiente al bien a entregar en Administración del Espacio Público), ubicado
                                en la dirección (digite la dirección del bien teniendo en cuenta el manual de
                                nomenclatura), cuyo tipo es (Digite el tipo de bien, si es casa, local, bodega, etc.),
                                escritura N° (digite el número de la escritura) del (digite el día de la escritura) de
                                (Digite el mes de la escritura) de (Digite el número del año de la escritura), el
                                espacio a entregar en Administración del Espacio Público consta de (Digite el número de
                                metros cuadrados que comprende el bien a entregar) m<span className="ft16">2</span>,
                                cuyas áreas y linderos se describen de la siguiente manera, según informe de prediación
                                con radicado: (Digite el número del radicado del informe de prediación) del (digite el
                                día del informe) de (Digite el mes del informe) de (Digite el número del año del
                                informe).
                            </p>
                            <p className="p26 ft0">
                                <span className="ft3">3.</span>
                                <span className="ft4">Destinación</span>: debe destinarse el inmueble para: (Describir
                            ...
                            <p className="p5 ft3" style={{ marginBottom: '15px' }}>
                                4.1 Obligaciones del administrador.
                            </p>
                            <p className="p9 ft0">
                                El <span className="ft17">ADMINISTRADOR</span>, se obliga: 1) A emplear el mayor cuidado
                                en la conservación de los bienes, objeto de este contrato, siendo responsable de
                                cualquier deterioro que no provenga de la naturaleza o uso legítimo de la cosa. 2) A
                                impedir que el inmueble sea ocupado para asuntos diferentes a los mencionados en la
                                cláusula tercera. 3) A realizar las reparaciones locativas y a reparar los deterioros
                                que provengan de su actividad o de las de sus dependientes, salvo el deterioro que
                                provenga por el paso del tiempo y el uso normal del inmueble. 4) A impedir que personas
                                ajenas al presente contrato se instalen en forma temporal o definitiva en el inmueble
                                mencionado. 5) A restituir el inmueble dentro de los treinta (30) días siguientes a la
                                solicitud de entrega formulada por la Administración Municipal. 6) A no variar la
                                ...
                                el pago de todos los servicios públicos contratados y trabajos realizados por cuenta del{' '}
                                <span className="ft17">ADMINISTRADOR</span>, y ante los requerimientos de quién tenga a
                                su cargo la supervisión. 10) Deberá proveer la respectiva vigilancia del inmueble. 11)
                                Estar registrado previamente en el SECOP II, con el fin de publicar los documentos
                                contractuales. 12) Presentar un informe trimestral al supervisor del contrato sobre el
                                uso, estado, destino, conservación del bien y las cuentas de servicios canceladas, así
                                como de la facturas de pago de las cuotas de administración, cuando a ello hubiere
                                lugar. 13) Rea lizar adaptaciones y mejoras con la aprobación por escrito de la
                                Secretaria de Suministros y Servicios, las cuales serán por su cuenta y riesgo. 14)
                                Asumir los gastos generados por el uso normal, el mantenimiento, la conservación y
                                vigilancia del bien inmueble, así como los correspondientes a la legalización del
                                contrato como garantías, impuestos y publicación cuando a ello haya lugar. 15) Presentar
                                un informe trimestral al supervisor del contrato, sobre el uso, estado, destino,
                                conservación del bien y las cuentas de servicios canceladas y cuotas de administración
                            </p>
                ...
                <Card style={{ width: '850px', margin: '0 auto', marginTop: '10px' }}>
                    <div id="page_4">
                        ...
                        <div id="id4_2">
                            <p className="p9 ft0">
                                cuando hubiera lugar. 16) Restituir el inmueble dado den Administración del Espacio
                                Público dentro de los treinta (30) días hábiles siguientes a la solicitud del mismo. 17)
                                Participar en la liquidación del contrato y suscribir las actas correspondientes. (18)
                                Si requiere más obligaciones de las anteriores digítelas en este espacio siguiendo la
                                numeración, de lo contrario suprima todo este texto y numeral) Las demás obligaciones
                                propias de los contratos de Administración del Espacio Públicos, de acuerdo con las
                            ...
                            <p className="p30 ft21">
                                ...
                                <span className="ft20">
                                    Realizar en el inmueble objeto del contrato de administración de espacio público,
                                    cualquier actividad de la cual se genere aprovechamiento económico para este de
                                    manera privada y por fuera de la destinación del inmueble, y las demás prohibiciones
                                    contempladas en la normatividad vigente. El incumplimiento de esta cláusula, dará
                                    lugar a la terminación del contrato de administración de espacio público. 2) Queda
                                    expresamente prohibido en los inmuebles entregados en Administración del Espacio
                                    Público no deben almacenar, consumir o expender bebidas alcohólicas, sustancias
                                    psicoactivas o alucinógenas. 3) Utilización para eventos políticos, cultos
                                    religiosos, parqueaderos entre otros que no estén estipulados expresamente dentro
                                    del objeto y alcance del presente contrato de Administración del Espacio Público. 4)
                                    Cobrar cualquier suma de dinero o contraprestación a la comunidad por el ingreso o
                                    acceso al inmueble dado en Administración del Espacio Público, salvo en aquellos
                                    casos previamente autorizados por la Secretaría de Suministros y Servicios. 5)
                                    Arrendar o ceder el inmueble, o parte de él, para desarrollar cualquier tipo de
                                    actividad, sin obtener autorización previa y escrita de la Secretaría de Suministros
                                    y Servicios. 6) Ubicar casetas, tiendas o publicidad sin la debida autorización de
                                    la Subsecretaría, Defensoría del Espacio Público y de la Secretaría de Suministros y
                                    Servicios. 7) Destinar el inmueble entregado en Administración del Espacio Público a
                                    actividades diferentes para la que fue concedido. 8) Instalar negocios comunitarios.
                                    9) Realizar bailes públicos entendidos como aquellos anunciados abiertamente, con
                                    cobro de ingreso, venta de licor y cuyo único objetivo es el recaudo de fondo para
                                    los organizadores. 10) Extender más allá del horario permitido por las autoridades
                                    competentes las reuniones sociales (primeras comuniones, matrimonios, cumpleaños) y
                                    actividades de integración, educación o financiación. 11) Desarrollar actividades
                                    que superen los índices permitidos de ruido, para zonas residenciales o comunitarias
                                    o que generen conflictos de convivencia con la vecindad, en acuerdo a lo preceptuado
                                    en el Código Nacional de Policía vigente, sin perjuicio de los manuales o normas de
                                    convivencia que regulen el tema nivel Municipal o Departamental. 12) Si requiere más
                                    prohibiciones de las anteriores digítelas en este espacio siguiendo la numeración,
                                    de lo contrario suprima todo este texto y numeral).
                                </span>
                            </p>
                            <p className="p31 ft0">
                                Todas aquellas que en ejecución del contrato resulten contrarias a los fines del
                                Administración del Espacio Público, la convivencia ciudadana y los intereses del
                                Municipio de Medellín.
                            </p>
                            <p className="p24 ft0">
                                <span className="ft3">Plazo del contrato: </span>El plazo del contrato de Administración
                                del Espacio Público a celebrar será de (Digite en letras y números la duración del
                                contrato), contados a partir de la entrega del inmueble, mediante acta suscrita por las
                            ...
                            <p className="p24 ft0">
                                ...
                                contrato de Administración del Espacio Público de forma unilateral.
                            </p>
                ...
                <Card style={{ width: '850px', margin: '0 auto', marginTop: '10px' }}>
                    <div id="page_5">
                        ...
                        <div id="id5_2">
                            ...
                            <p className="p10 ft0">
                                La Ley 80 de 1993, 1150 de 2007 y sus decretos reglamentarios en especial el Decreto
                                1082 de 2015.
                            </p>
                            <p className="p24 ft5">
                            ...
                            <p className="p24 ft0">
                                ...
                                Municipal, para efectos fiscales y de constitución de las garantías a que haya lugar, se
                                le asigna al mismo (digite el valor del contrato en letras) (digite el valor del
                                contrato en números), que corresponde a la debida administración y mantenimiento del
                                inmueble entregado a título de Administración de Bien Inmueble de Uso Público. Dicha
                                suma es el resultado del valor que deberá costear EL ADMINISTRADOR, de conformidad con
                                la cotización de mantenimiento anual presentada por la misma.
                            </p>
                            <p className="p5 ft3">
                                7. La justificación de los factores de selección que permitan identificar el mejor
                                solicitante.
                            </p>
                            <p className="p24 ft5">
                                Los factores de selección del ADMINISTRADOR cuando exista más de un solicitante se
                                regirá por los definidos en la normativa vigente, para lo cual se dejará un documento
                                anexo de la evaluación de los requisitos.
                            </p>
                            <p className="p33 ft3">
                            ...
                            <p className="p11 ft5">Incumplimiento de las obligaciones surgidas del contrato.</p>
                            <p className="p11 ft5">Pago de salarios, prestaciones sociales e indemnizaciones.</p>
                    ...
                    <div id="page_6">
                        ...
                        <div id="id6_2">
                            ...
                            <table cellPadding="0" cellSpacing="0" className="t0">
                                <tr>
                                    ...
                                    <td className="tr0 td1">
                                        <p className="p41 ft0">Grado de</p>
                                    </td>
                                    ...
                                    <td className="tr0 td3">
                                        <p className="p41 ft0">Municipio</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr1 td5">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td6">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td7">
                                        <p className="p41 ft24">Ocurrencia</p>
                                    </td>
                                    <td className="tr1 td8">
                                        <p className="p41 ft24">Impacto</p>
                                    </td>
                                    <td className="tr1 td7">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="tr2 td21">
                                        <p className="p41 ft0">Ejercer</p>
                                    </td>
                                    <td className="tr2 td22">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr2 td23">
                                        <p className="p43 ft0">un</p>
                                    </td>
                                    <td className="tr2 td24">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} className="tr2 td25">
                                        <p className="p42 ft0">control</p>
                                    </td>
                                    <td className="tr2 td17">
                                        <p className="p44 ft0">y</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td rowSpan={2} className="tr3 td18">
                                        <p className="p41 ft0">MEDIO</p>
                                    </td>
                                    <td rowSpan={2} className="tr3 td19">
                                        <p className="p41 ft0">MEDIO</p>
                                    </td>
                                    <td rowSpan={2} className="tr3 td18">
                                        <p className="p41 ft0">X</p>
                                    </td>
                                    <td className="tr2 td20">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    ...
                                    <td className="tr2 td17">
                                        <p className="p44 ft0">al</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr4 td20">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                    ...
                                    <td rowSpan={2} className="tr5 td31">
                                        <p className="p45 ft27">parte</p>
                                    </td>
                                    <td className="tr4 td29">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                    <td rowSpan={2} className="tr5 td17">
                                        <p className="p44 ft27">del</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr6 td16">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    <td className="tr6 td17">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    <td className="tr6 td18">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr7 td5">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td6">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td7">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td8">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td7">
                                        <p className="p42 ft25">&nbsp;</p>
                                    ...
                                    <td className="tr7 td13">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td14">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr5 td16">
                                        <p className="p42 ft29">&nbsp;</p>
                                    </td>
                                    <td className="tr5 td17">
                                        <p className="p42 ft29">&nbsp;</p>
                                    </td>
                                    <td className="tr5 td18">
                                        <p className="p42 ft29">&nbsp;</p>
                                    </td>
                                    <td className="tr5 td19">
                                        <p className="p42 ft29">&nbsp;</p>
                                    </td>
                                    <td className="tr5 td18">
                                        <p className="p42 ft29">&nbsp;</p>
                                ...
                                <tr>
                                    ...
                                    <td className="tr2 td31">
                                        <p className="p45 ft0">al</p>
                                    </td>
                                    <td colSpan={2} className="tr2 td35">
                                        <p className="p44 ft0">bien</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colSpan={2} className="tr2 td28">
                                        <p className="p45 ft0">objeto</p>
                                    </td>
                                    <td className="tr2 td29">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr2 td17">
                                        <p className="p44 ft0">del</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr2 td16">
                                ...
                                <tr>
                                    <td className="tr1 td16">
                                        <p className="p40 ft24">prohibiciones</p>
                                    </td>
                                    <td className="tr1 td17">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr2 td16">
                                        <p className="p40 ft0">contraídas</p>
                                    </td>
                                    <td className="tr2 td17">
                                        <p className="p44 ft0">en</p>
                                    </td>
                                    <td className="tr2 td18">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="tr2 td21">
                                        <p className="p41 ft0">del</p>
                                    </td>
                                    <td colSpan={4} className="tr2 td39">
                                        <p className="p42 ft0">supervisor</p>
                                    </td>
                                    <td colSpan={2} className="tr2 td35">
                                        <p className="p44 ft0">para</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr2 td16">
                                        <p className="p40 ft0">contrato.</p>
                                    </td>
                                    <td className="tr2 td17">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                            ...
                            <table cellPadding="0" cellSpacing="0" className="t1">
                                <tr>
                                    <td className="tr0 td42">
                                        <p className="p40 ft0">Tipificación</p>
                                    </td>
                                    <td className="tr0 td43">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} className="tr0 td44">
                                        <p className="p41 ft0">Estimación</p>
                                    </td>
                                    <td className="tr0 td45">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} className="tr0 td46">
                                        <p className="p42 ft0">Mecanismo</p>
                                    </td>
                                    <td colSpan={2} className="tr0 td47">
                                        <p className="p41 ft0">de</p>
                                    </td>
                                    <td className="tr0 td48">
                                        <p className="p41 ft0">Asignación</p>
                                    </td>
                                    <td className="tr0 td49">
                                        <p className="p41 ft0">Vigencia</p>
                                    </td>
                                    <td className="tr0 td50">
                                        <p className="p41 ft0">Aplica</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr1 td51">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    ...
                                    <td className="tr1 td56">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td57">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td58">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="tr9 td62">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td63">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td17">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td64">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td65">
                                        <p className="p42 ft31">Garantía</p>
                                    </td>
                                    <td className="tr9 td66">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} className="tr9 td67">
                                        <p className="p49 ft31">de</p>
                                    </td>
                                    <td className="tr9 td68">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td69">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                    <td className="tr9 td70">
                                        <p className="p42 ft30">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="tr7 td63">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td17">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td64">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} className="tr2 td46">
                                        <p className="p42 ft0">
                                            <span className="ft32">Cumplimiento</span>:
                                        </p>
                                    </td>
                                    <td className="tr2 td71">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td72">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td68">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td69">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td70">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr6 td62">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    ...
                                    <td rowSpan={2} className="tr5 td65">
                                        <p className="p42 ft27">Ampara</p>
                                    </td>
                                    <td className="tr6 td66">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    <td colSpan={2} rowSpan={2} className="tr5 td67">
                                        <p className="p49 ft27">al</p>
                                    </td>
                                    <td className="tr6 td68">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    <td className="tr6 td69">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                    <td className="tr6 td70">
                                        <p className="p42 ft28">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td rowSpan={2} className="tr10 td62">
                                        <p className="p42 ft0">de</p>
                                    </td>
                                    <td rowSpan={2} className="tr10 td63">
                                        <p className="p41 ft0">10%</p>
                                    </td>
                                    <td rowSpan={2} className="tr10 td17">
                                        <p className="p42 ft0">del</p>
                                    </td>
                                    <td className="tr4 td64">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                    <td className="tr4 td66">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                    <td className="tr4 td68">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                    <td rowSpan={2} className="tr10 td69">
                                        <p className="p41 ft0">Plazo del</p>
                                    </td>
                                    <td className="tr4 td70">
                                        <p className="p42 ft26">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr11 td64">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                    <td colSpan={4} className="tr11 td73">
                                        <p className="p42 ft34">Beneficiario el total y</p>
                                    </td>
                                    <td className="tr11 td68">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                    <td className="tr11 td70">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td rowSpan={2} className="tr8 td63">
                                        <p className="p41 ft0">valor</p>
                                    </td>
                                    <td rowSpan={2} className="tr8 td17">
                                        <p className="p42 ft0">del</p>
                                    </td>
                                    <td className="tr11 td64">
                                        <p className="p42 ft33">&nbsp;</p>
                                    ...
                                    <td className="tr11 td66">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                    <td className="tr11 td74">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                    <td className="tr11 td72">
                                        <p className="p42 ft33">&nbsp;</p>
                                    </td>
                                    ...
                                    <td rowSpan={2} className="tr8 td70">
                                        <p className="p41 ft0">SI</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="tr12 td62">
                                        <p className="p42 ft35">&nbsp;</p>
                                    </td>
                                    <td className="tr12 td64">
                                        <p className="p42 ft35">&nbsp;</p>
                                    </td>
                                    <td className="tr12 td66">
                                        <p className="p42 ft35">&nbsp;</p>
                                    </td>
                                    <td className="tr12 td74">
                                        <p className="p42 ft35">&nbsp;</p>
                                    </td>
                                    <td className="tr12 td72">
                                        <p className="p42 ft35">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className="tr13 td61">
                                        <p className="p40 ft36">contraídas</p>
                                    </td>
                                    <td className="tr13 td62">
                                        <p className="p42 ft36">en</p>
                                    </td>
                                    <td className="tr13 td17">
                                        <p className="p42 ft37">&nbsp;</p>
                                    </td>
                                    <td className="tr13 td64">
                                        <p className="p42 ft37">&nbsp;</p>
                                    </td>
                                    <td className="tr13 td68">
                                        <p className="p42 ft37">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="tr1 td63">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td17">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td64">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td65">
                                        <p className="p42 ft24">contrato</p>
                                    </td>
                                    <td className="tr1 td66">
                                        <p className="p42 ft24">pactado</p>
                                    </td>
                                    <td colSpan={2} className="tr1 td67">
                                        <p className="p49 ft24">de</p>
                                    </td>
                                    <td className="tr1 td68">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td69">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                    <td className="tr1 td70">
                                        <p className="p42 ft23">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr14 td63">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                    <td className="tr14 td17">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                    <td className="tr14 td64">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                    <td rowSpan={2} className="tr5 td65">
                                        <p className="p42 ft27">acuerdo</p>
                                    </td>
                                    <td rowSpan={2} className="tr5 td66">
                                        <p className="p50 ft27">a</p>
                                    </td>
                                    <td colSpan={2} rowSpan={2} className="tr5 td67">
                                        <p className="p49 ft21">sus</p>
                                    </td>
                                    <td className="tr14 td68">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                    <td className="tr14 td69">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                    <td className="tr14 td70">
                                        <p className="p42 ft38">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr15 td61">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td62">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td63">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td17">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td64">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td68">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td69">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                    <td className="tr15 td70">
                                        <p className="p42 ft39">&nbsp;</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="tr7 td51">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td52">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td53">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td6">
                                        <p className="p42 ft25">&nbsp;</p>
                                    ...
                                    <td className="tr7 td76">
                                        <p className="p42 ft0">términos,</p>
                                    </td>
                                    <td className="tr7 td77">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td56">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td57">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td58">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr7 td59">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr16 td78">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td79">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td63">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td80">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td64">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td65">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td66">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td74">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    <td className="tr16 td81">
                                        <p className="p42 ft25">&nbsp;</p>
                                    </td>
                                    ...
                                    <td className="tr16 td82">
                                        <p className="p51 ft11">Página 6 de 8</p>
                                    </td>
                                </tr>
                            </table>
                ...
                <Card style={{ width: '850px', margin: '0 auto', marginTop: '10px' }}>
                    <div id="page_7">
                        ...
                        <div id="id7_2">
                            ...
                            <p className="p24 ft0">
                                <span className="ft3">Cláusula Penal Pecuniaria</span>: Se estipula una clausula penal
                                ...
                                ADMINISTRADOR no aporta la garantía de cumplimiento exigida, se procederá a dejar
                                constancia por escrito y se iniciarán los procedimientos necesarios requeridos para que
                                se dé por terminado el contrato.
                            </p>
                            <p className="p26 ft3">
                                11. Auditoria Interna<span className="ft0">:</span>
                            </p>
                            <p className="p10 ft0">
                                ...
                                requerimientos de la Auditoria interna serán sujetos de Multa por mora en la entrega de
                                información. Con fundamento en el Decreto Municipal 2505 del 17 de Diciembre de 2013; y
                                la Circular N° 002 del 10 de Enero de 2014, emitida por el Comité Técnico de Orientación
                                y Seguimiento de la Contratación.
                            </p>
                            ...
                            <p className="p24 ft5">
                                ...
                                Administración del Espacio Público (Digitar los riesgos ambientales que apliquen para el
                                contrato).
                            </p>
                            ...
                            <p className="p24 ft0">
                                ...
                                ejercida por un Servidor Público designado por la Secretaría de Suministros y Servicios,
                                ...
                                sobre hechos imputables al ADMINISTRADOR y que pueda causar perjuicios al Municipio
                            </p>
                ...
                <Card style={{ width: '850px', margin: '0 auto', marginTop: '10px' }}>
                    <div id="page_8">
                        ...
                        <div id="id8_2">
                            <p className="p4 ft0">
                                de Medellín como propietario del inmueble. La designación hará parte integrante del
                                contrato.
                            </p>
                            <p className="p59 ft0">
                            ...
                            <p className="p24 ft0">
                                ...
                                de 2015, y con el artículo 223 del
                                <span>Decreto-Ley</span> 019 de 2012, el presente contrato una vez perfeccionado, deberá
                                ser publicado por parte del
                                ...
                                <a href="http://www.colombiacompra.gov.co">
                                    <span className="ft32">www.colombiacompra.gov.co</span>
                                </a>
                                .
                            </p>
                            <p className="p60 ft0">
                                <span className="ft3">16.</span>
                                <span className="ft40">Línea del Plan de Desarrollo: </span>Dimensión: 1 Creemos en la
                                confianza ciudadana; Reto: 1.3
                            </p>
                            <p className="p61 ft5">
                            ...
                            <table cellPadding="0" cellSpacing="0" className="t2">
                                ...
                                <tr>
                                    <td className="tr2 td86">
                                        <p className="p40 ft0">(Nombre)</p>
                                    </td>
                                    <td className="tr2 td87">
                                        <p className="p41 ft0">(Nombre)</p>
                                    </td>
                                ...
                                <tr>
                                    <td className="tr18 td86">
                                        <p className="p40 ft0">(Cargo)</p>
                                    </td>
                                    <td className="tr18 td87">
                                        <p className="p41 ft0">(Cargo)</p>
                                    </td>

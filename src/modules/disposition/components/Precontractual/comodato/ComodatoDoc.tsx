                    ...
                    <div id="page_1">
                        ...
                        <div id="id1_2">
                            ...
                            <p className="p12_comodato ft13_comodato">
                                ...
                                acuerdo con la particularidad, función, reconocimiento y operación territorial
                    ...
                    <div id="page_2">
                        ...
                        <div id="id2_2">
                            <p className="p8_comodato ft0_comodato">
                                ...
                                indicó antes y para el caso concreto, se identificó que <span className="ft3_comodato">{` ${values?.names_applicant}, `}</span>
                            ...
                            <p className="p19_comodato ft0_comodato">
                                De acuerdo con lo expuesto y la documentación aportada, <span className="ft3_comodato">{` ${values?.names_applicant}, `}</span>
                                {/* <span className="ft3_comodato"> (DIGITE LA RAZÓN SOCIAL DE LA ENTIDAD COMODATARIA)</span> */}
                                ...
                                actividades, <span className="ft3_comodato">{`${values?.activities} `}</span>(Realice una descripción detallada de la necesidad que se
                                ...
                                apoyará con su operación), beneficiando a
                                ...
                                <span className="ft3_comodato">{` ${realEstate?.registry_number}`}</span>, {/*(digite el
                                número de la matrícula inmobiliaria del bien a entregar en comodato)*/}
                                CBML <span className="ft3_comodato">{` ${realEstate?.address?.cbmls?.sap.cb}${realEstate?.address?.cbmls?.sap.ml}`}</span>
                                {/*(Digite el número del CMBL del bien inmueble)*/},
                                activo fijo <span className="ft3_comodato">{`${realEstate?.sap_id}`}</span>,
                            ...
                            <p className="p23_comodato ft22_comodato">
                                ...
                                Municipio de Medellín identificado con matrícula <span className="ft3_comodato">{realEstate?.registry_number}</span>,
                                {/*(digite el número de la matrícula inmobiliaria del bien a entregar en comodato)*/} CBML
                    ...
                    <div id="page_3">
                        ...
                        <div id="id3_2">
                            <p className="p8_comodato ft0_comodato">
                                ...
                                >2 </span
                                >el cual <span className="ft3_comodato">{values?.Horizontal_property}</span> {/*(indicar si o no)*/} se encuentra sometido a régimen de
                        ...
                        <div id="id4_2">
                            ...
                            <p className="p23_comodato ft6_comodato">
                                ...
                                >Realizar en el inmueble objeto del contrato de comodato cualquier
                                    ...
                                    por las autoridades competentes las reuniones sociales <span className="ft3_comodato">{`(${values?.social_event})`}</span> y actividades de integración,
                                    ...
                                    tiene adscrito el inmueble entregado en comodato.</span>
                            </p>
                            <span className="ft3_comodato">
                    ...
                    <div id="page_5">
                        ...
                        <div id="id5_2">
                            <p className="p8_comodato ft0_comodato">
                                ...
                                de comodato a celebrar será de <span className="ft3_comodato">({values?.contract_period}) {writtenNumber(values?.contract_period, { lang: 'es' })}</span> meses,
                            ...
                            <p className="p10_comodato ft22_comodato">
                                Para el presente contrato el valor de los servicios públicos <span className="ft3_comodato">{values?.public_service}</span> {/*(indicar
                                si o no)*/} se determinó por aforo.
                                <span className="ft3_comodato">
                                {values?.public_service === "si" && ` cuyo valor es ($${values?.value_public_service})
                        ...
                        <div id="id7_2">
                            ...
                            <table cellPadding="0" cellSpacing="0" className="t0_comodato">
                                <tr>
                                    ...
                                    <td className="tr0 td1"><p className="p46_comodato  ft0">Grado de ocurrencia</p></td>
                                    <td className="tr0 td2"><p className="p46_comodato  ft0">Grado de impacto</p></td>
                                    <td className="tr0 td1"><p className="p46_comodato my-3 ft0">Contratista</p></td>
                                    <td className="tr0 td3"><p className="p46_comodato my-3 ft0">Municipio</p></td>
                                    <td colSpan={6} className="tr0 td4">
                                        <p className="text-center my-3 ft0">Mecanismo de Mitigación</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan={2} className="tr0 td1_comodato" style={{borderLeft: '1px solid #000'}}>
                                        <p className="p45_comodato my-4 ft0" >REGULATORIO</p>
                                    </td>
                                    <td className="tr0 td1_comodato"><p className="text-center my-4 ft0">{values?.regulatory_degree_occurrence === "" ? "MEDIO" : values?.regulatory_degree_occurrence}</p></td>
                                    <td className="tr0 td1_comodato"><p className="text-center  my-4 ft0">{values?.regulatory_impact_degree === "" ? "MEDIO" : values?.regulatory_impact_degree}</p></td>
                                    {values?.regulatory_responsable === "municipio" &&
                                        <>
                                            <td className="tr0 td1_comodato"><p className="text-center my-4 ft0"></p></td>
                                            <td className="tr0 td1_comodato"><p className="text-center my-4 ft0">X</p></td>
                                        </>
                                    }
                                ...
                                <tr style={{ borderBottom: '1px solid #000' }}>
                                    ...
                                    <td className="tr0 td1_comodato"><p className="text-center ft0" >{values?.operative_degree_occurrence === "" ? "MEDIO" : values?.operative_degree_occurrence}</p></td>
                                    <td className="tr0 td1_comodato"><p className="text-center ft0" >{values?.operative_impact_degree === "" ? "MEDIO" : values?.operative_impact_degree}</p></td>
                                    {values?.operative_responsable === "municipio" &&
                                        <>
                                            <td className="tr0 td1_comodato"><p className="text-center ft0" ></p></td>
                                            <td className="tr0 td1_comodato"><p className="text-center ft0" >X</p></td>
                                        </>
                                    }
                            ...
                            {values?.resolution === "si" ?
                                    ...
                                    <table cellPadding="0" cellSpacing="0" className="t1_comodato">
                                        ...
                                        <tr>
                                            <td className="tr2_comodato td43_comodato" >
                                                <p className="p55_comodato ft0_comodato" style={{ width: '280px', height: 'auto' }}>
                                                    Valor de las reparaciones locativas y deterioros a cargo del comodatario.
                                                    (Estimación de valor de las posibles reparaciones y deterioros que pueda
                                                    requerir el bien inmueble, según informe realizado por la Secretaría o
                                                    dependencia que tenga a cargo el inmueble)
                                                </p>
                                            </td>
                                            <td className="tr2_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '60px' }}>${values?.value_locative_repairs}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr5_comodato td43_comodato">
                                                <p className="p55_comodato ft18_comodato" style={{ width: '280px', height: 'auto' }}>
                                                    Valor de eventuales reparaciones por daños a terceros (estimación según
                                                    informe realizado por la Secretaría o dependencia que tenga a cargo el
                                                    inmueble)
                                                </p>
                                            </td>
                                            <td className="tr5_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '30px' }}>$ {values?.value_repairs_damages}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr5_comodato td43_comodato">
                                                <p className="p55_comodato ft18_comodato" style={{ width: '280px', height: 'auto' }}>
                                                    Valor de los servicios públicos domiciliarios (incluir energía, acueducto,
                                                    alcantarillado, saneamiento, gas, telefonía, internet, televisión y demás
                                                    servicios suscritos con las empresas prestadoras de servicios públicos que se
                                                    deban mantener al día por el uso del inmueble según informe realizado por la
                                                    Secretaría o dependencia que tenga a cargo el inmueble)
                                                </p>
                                            </td>
                                            <td className="tr5_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '60px' }}>$ {values?.value_domiciliary_public}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr2_comodato td43_comodato">
                                                <p className="p55_comodato ft0_comodato">Valor gastos de vigilancia</p>
                                            </td>
                                            <td className="tr2_comodato td44_comodato"><p className="p65_comodato ft3">$ {values?.surveillance_value}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr5_comodato td43_comodato">
                                                <p className="p55_comodato ft18_comodato">Valor gastos de aseo</p>
                                            </td>
                                            <td className="tr5_comodato td44_comodato"><p className="p65_comodato ft3">$ {values?.cleaning_value}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr2_comodato td43_comodato">
                                                <p className="p55_comodato ft0_comodato">
                                                    Valor gastos de conservación y mantenimiento en general que le correspondan al comodatario,
                                                    el cual deberá actualizarse para cada vigencia según IPC durante el termino de duración
                                                    del contrato.
                                                </p>
                                            </td>
                                            <td className="tr2_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '30px' }}>$ {values?.conservation_value}</p></td>
                                        </tr>
                                    </table>
                                </>
                                :
                                <>
                                    ...
                                    <table cellPadding="0" cellSpacing="0" className="t2_comodato">
                                        <tr>
                                            <td className="tr13_comodato td48_comodato" style={{ borderRight: '1px solid #000' }}>
                                            ...
                                            <td className="tr11_comodato td1">
                                                <p className="p55_comodato ft0_comodato my-3">
                                                    Asignación</p>
                                            </td>
                                            <td className="tr13_comodato td1">
                                        ...
                                        <tr style={{ borderBottom: '1px solid #000' }}>
                                            <td className="tr13_comodato td1_comodato" style={{ borderRight: '1px solid #000', borderLeft: '1px solid #000' }}>
                                                <p className="p45_comodato ft0_comodato"> {/*style={{ marginBottom: '320px' }}*/}
                                                    Incumplimiento del
                                                    contratista de las
                                                    obligaciones y
                                                    prohibiciones
                                            ...
                                            <td className="tr13_comodato td1_comodato">
                                                <p className="p46_comodato ft0_comodato">
                                                    {/*(indicar el número)*/}{values?.lockable_base} % del valor obtenido como base asegurable.
                                            ...
                                            <td className="tr11_comodato td1_comodato">
                                                <p className="p46_comodato ft0_comodato" > {/*style={{ marginBottom: '250px' }}*/}
                                                    Garantía de Cumplimiento: Ampara al Beneficiario el total y perfecto
                                                    cumplimiento del contrato pactado de acuerdo a sus términos, condiciones y
                                                    especificaciones contractuales
                                                </p>
                                            </td>
                                            <td className="tr11_comodato td1_comodato">
                                                <p className="p55_comodato ft0_comodato" > {/*style={{ marginBottom: '435px' }}*/}
                                                    Contratista
                                                </p>
                                            </td>
                                            <td className="tr13_comodato td1_comodato">
                                                <p className="p46_comodato ft0_comodato" > {/*style={{ marginBottom: '380px' }}*/}
                                                    Plazo del contrato y 4 meses más
                                                </p>
                                            </td>
                                            {/* <td className="tr11_comodato td49_comodato"><p className="p47_comodato ft43_comodato">&nbsp;</p></td> */}
                                            <td className="tr11_comodato td1_comodato"><p className="text-center p46_comodato ft0_comodato" >SI</p></td> {/*style={{ marginBottom: '430px' }}*/}
                                        </tr>
                                ...
                                <>
                                    <table cellPadding="0" cellSpacing="0" className="t1_comodato">
                                        <tr style={{ borderTop: '1px solid #000' }}>
                                            ...
                                            <td className="tr2_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '10px' }}>$ {values?.administration_value}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr5_comodato td43_comodato">
                                            ...
                                            <td className="tr5_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '10px' }}>$ {values?.network_value}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr5_comodato td43_comodato">
                                                <p className="p55_comodato ft18_comodato">
                                                    ...
                                                    el porcentaje del valor exigido tenga la suficiencia necesaria
                                                    para que su incumplimiento quede cubierto
                                                </p>
                                            </td>
                                            <td className="tr5_comodato td44_comodato"><p className="p65_comodato ft3" style={{ marginBottom: '60px' }}>$ {values?.Value_economic_obligations}</p></td>
                                        </tr>
                                        <tr>
                                            <td className="tr2_comodato td43_comodato">&nbsp;</td>
                                            <td className="tr2_comodato td44_comodato">
                                                <p className="p55_comodato ft3_comodato">Valor total:
                                                    <span className="ft3" style={{ paddingLeft: '30px' }}>$ {

                                                        values?.Value_economic_obligations + values?.network_value + values?.administration_value + values?.conservation_value + values?.cleaning_value + values?.surveillance_value + values?.value_domiciliary_public + values?.value_repairs_damages + values?.value_locative_repairs
                                                    }
                                    ...
                                    <table cellPadding="0" cellSpacing="0" className="t2_comodato">
                                        ...
                                        <tr style={{ borderBottom: '1px solid #000' }}>
                                            ...
                                            <td className="tr13_comodato td1">
                                                <p className="p46_comodato ft0_comodato">
                                                    (indicar el número) % del valor obtenido como base asegurable.
                                                    (La Secretaría que entrega el inmueble debe determinar el % de
                                                    acuerdo a la base asegurable obtenida a partir de la sumatoria de la
                                                    cuantificación de las obligaciones contractuales y extracontractuale
                                                    vigente del inmueble, que cubra con suficiencia los riesgos que se
                                            ...
                                            {/* <td className="tr11_comodato td49_comodato"><p className="p47_comodato ft43_comodato">&nbsp;</p></td> */}
                                            <td className="tr11_comodato td49_comodato"><p className="text-center p46_comodato ft0_comodato" style={{ marginBottom: '430px' }}>SI</p></td>
                                        </tr>
                    ...
                    <div id="page_10">
                        ...
                        <div id="id10_2">
                            ...
                            <p className="p75_comodato ft0_comodato">
                                ...
                                inmueble entregado en comodato <span className="ft3_comodato">{values?.environmental_risk}.</span>
                    ...
                    <div id="page_12">
                        ...
                        <div id="id12_2">
                            ...
                            <p className="p44_comodato ft0_comodato">
                                ...
                                único de Contratación <a href="http://www.colombiacompra.gov.co"
                            ...
                            <p className="p81_comodato ft22_comodato" style={{ marginTop: '49px' }}>{`${values?.name_Leader} ${values?.lastname_Leader}`}{/*(Digite Nombres y apellidos)*/}</p>
                            <p className="p81_comodato ft22_comodato">{`${values?.post_leader}`}{/*(Digite cargo)*/}</p>
                            <p className="p81_comodato ft22_comodato">{`${values?.dependence_leader}`}{/*(Digite dependencia)*/}</p>
                            <p className="p81_comodato ft22_comodato">{`${values?.Secretary_leader}`}{/*(Digite secretaria)*/}</p>
                        </div>
                        <div id="id12_3">
                            <table cellPadding="0" cellSpacing="0" className="t3_comodato">
                                ...
                                <tr>
                                    <td className="tr2 td86"><p className="ft0" style={{ width: '215px', paddingLeft: '7px' }}>{values?.name_elaborated}{/*(Nombre)*/}</p></td>
                                    <td className="tr2 td87"><p className="ft0" style={{ width: '215px', paddingLeft: '7px' }}>{values?.name_revised}{/*(Nombre)*/}</p></td>
                                    <td className="tr2 td88"><p className="ft0" style={{ width: '215px', paddingLeft: '7px' }}>{values?.name_approved}{/*(Nombre)*/}</p></td>
                                </tr>
                                <tr>
